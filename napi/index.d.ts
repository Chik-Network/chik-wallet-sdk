...
export declare class Constants {
  ...
  static chiklispDeserialisation(): Buffer
  static chiklispDeserialisationHash(): Buffer
...
export declare class RestrictionMemo {
  ...
  static force1Of2RestrictedVariable(klvm: Klvm, leftSideSubtreeHash: Uint8Array, nonce: number, memberValidatorListHash: Uint8Array, delegatedPuzzleValidatorListHash: Uint8Array): RestrictionMemo
  static enforceDelegatedPuzzleWrappers(klvm: Klvm, wrapperMemos: Array<WrapperMemo>): RestrictionMemo
  static timelock(klvm: Klvm, seconds: bigint, reveal: boolean): RestrictionMemo
...
export declare class WrapperMemo {
  clone(): WrapperMemo
  static preventVaultSideEffects(klvm: Klvm, reveal: boolean): Array<WrapperMemo>
  static forceCoinAnnouncement(klvm: Klvm): WrapperMemo
  static forceCoinMessage(klvm: Klvm): WrapperMemo
  static preventMultipleCreateCoins(klvm: Klvm): WrapperMemo
  static timelock(klvm: Klvm, seconds: bigint, reveal: boolean): WrapperMemo
  static preventConditionOpcode(klvm: Klvm, opcode: number, reveal: boolean): WrapperMemo
...
export declare class MemberMemo {
  clone(): MemberMemo
  static k1(klvm: Klvm, publicKey: K1PublicKey, fastForward: boolean, reveal: boolean): MemberMemo
  static r1(klvm: Klvm, publicKey: R1PublicKey, fastForward: boolean, reveal: boolean): MemberMemo
  static bls(klvm: Klvm, publicKey: PublicKey, taproot: boolean, reveal: boolean): MemberMemo
  static passkey(klvm: Klvm, publicKey: R1PublicKey, fastForward: boolean, reveal: boolean): MemberMemo
  static singleton(klvm: Klvm, launcherId: Uint8Array, reveal: boolean): MemberMemo
  static fixedPuzzle(klvm: Klvm, puzzleHash: Uint8Array, reveal: boolean): MemberMemo
  constructor(puzzleHash: Uint8Array, memo: Program)
  get puzzleHash(): Buffer
  set puzzleHash(value: Uint8Array)
  get memo(): Program
...
export declare class ClawbackV2 {
  ...
  pushThroughSpend(klvm: Klvm): Spend
  puzzleHash(): Buffer
  memo(klvm: Klvm): Program
...
export declare class Clawback {
  ...
  receiverSpend(spend: Spend): Spend
  puzzleHash(): Buffer
  getRemarkCondition(klvm: Klvm): Remark
