...
#[derive(Clone)]
pub struct CoinsetClient(Arc<chik_sdk_coinset::CoinsetClient>);

impl CoinsetClient {
    pub fn new(base_url: String) -> Result<Self> {
        Ok(Self(Arc::new(chik_sdk_coinset::CoinsetClient::new(
            base_url,
        ))))
    }

    pub fn testnet11() -> Result<Self> {
        Ok(Self(Arc::new(chik_sdk_coinset::CoinsetClient::testnet11())))
    }

    pub fn mainnet() -> Result<Self> {
        Ok(Self(Arc::new(chik_sdk_coinset::CoinsetClient::mainnet())))
    }
