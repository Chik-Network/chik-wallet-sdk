...
use chik_puzzles::{singleton::SingletonArgs, Proof};
...
mod tests {
    ...
    use chik_bls::DerivableKey;
    use chik_puzzles::singleton::SingletonSolution;
    use chik_sdk_test::Simulator;
    use chik_sdk_types::{BlsMember, Conditions};
    ...
    fn test_single_sig() -> anyhow::Result<()> {
        ...
        let delegated_puzzle = ctx.alloc(&klvm_quote!(Conditions::new().create_coin(
